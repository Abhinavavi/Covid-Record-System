...
def ad():
    ...
    if cstatus.get()=="positive":
        p=open(r"C:\Users\nimit\Desktop\File-Structure-Mini-Project-main\COVIDET\positive.txt",'a')
        p.write(ls)
        p.close()
...
def add():
    ...
    os.system('python script.py')
def im():
    load = Image.open(r"C:\Users\nimit\Desktop\File-Structure-Mini-Project-main\COVIDET\img6.jpg")
...
if __name__=="__main__":
    ...
    root.minsize(935, 470)
    root.maxsize(935, 470)
    ...
    b6=Button(root,text="Add Employee",command=add,width=25)
