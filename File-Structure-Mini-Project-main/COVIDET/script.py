...
def pos():
    ret=verifier()
    if ret==0:
        h=open(r"C:\Users\nimit\Desktop\File-Structure-Mini-Project-main\COVIDET\admin.txt")
        lines = h.readlines()
        h.close()
        for i in lines:
...
def verifier():
    ...
    if a==1 or b==1 :
        ...
        return 0            
def im1():
    load = Image.open(r"C:\Users\nimit\Desktop\File-Structure-Mini-Project-main\COVIDET\img1.jpg")
    ...
    load1 = Image.open(r"C:\Users\nimit\Desktop\File-Structure-Mini-Project-main\COVIDET\img4.jpg")
